...
<div class="form-floating mb-3">
  <input type="text" class="form-control" name="apellidoCliente" placeholder="Apellido del Cliente">
  <label for="floatingInput">Apellido del Cliente</label>
                ...
                <a type="button" class="btn btn-warning" href="{{ route ('cliente.todos') }}">Ver Clientes</a>
    </div>    
            </form>
